    ...
    <section className="py-24 px-6">
      <div className="max-w-4xl mx-auto text-center bg-blue-600 rounded-3xl px-8 py-16 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <a href="https://syntek-platform.vercel.app/register" className="inline-flex items-center gap-2 bg-white text-blue-600 font-semibold px-8 py-4 rounded-2xl text-base hover:bg-blue-50 transition-all shadow-lg">
            {t("ctaFinal.cta")}
            <ArrowRight size={18} />
          </a>
        </div>
