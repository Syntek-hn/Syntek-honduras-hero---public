...
export default function QuienesSomos() {
  return (
    <section id="quienes-somos" className="py-24 bg-[#05050f] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-0 w-[500px] h-[500px] rounded-full blur-3xl pointer-events-none -translate-y-1/2 opacity-[0.03]"
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <AnimatedSection direction="left">
              <span className="inline-block px-4 py-1.5 rounded-full text-sm font-medium mb-5"
            ...
            <AnimatedSection direction="left" delay={0.1}>
              <p className="text-gray-400 text-base leading-relaxed">
                ...
                Creemos que cada negocio merece tecnología de punta trabajando 24/7. Basados en Honduras,
                trabajamos con negocios latinoamericanos que quieren crecer sin contratar más personal.
              </p>
            </AnimatedSection>
            ...
            <AnimatedSection direction="left" delay={0.2} className="mt-8">
              <a
                href="#formulario"
                className="btn-glow inline-flex items-center gap-2 px-7 py-3.5 rounded-xl text-black font-bold text-sm shadow-lg hover:scale-105 transition-transform"
          ...
          <AnimatedSection direction="right" className="flex flex-col gap-5">
            {datos.map((dato) => {
              ...
              return (
                <div
                  key={dato.label}
                  className="group relative rounded-2xl bg-[#0d0d1a] border border-white/5 p-6 flex items-center gap-5 hover:border-[#00D4FF]/20 transition-all duration-300 overflow-hidden"
                >
                  <div
